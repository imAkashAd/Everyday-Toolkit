...
class TemperatureViewScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(TemperatureViewScreenController());
  ...
  void _showUnitPicker(BuildContext context, TemperatureViewScreenController controller, bool isFrom) {

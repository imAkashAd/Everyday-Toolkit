...
import 'package:api_test/features/unit_converter/controller/weight_view_screen_controller.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';
import 'package:get/get.dart';

class WeightViewScreen extends StatelessWidget {
  const WeightViewScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(WeightViewScreenController());
  ...
  void _showUnitPicker(BuildContext context, WeightViewScreenController controller, bool isFrom) {
